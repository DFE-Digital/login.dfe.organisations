...
const getOrganisationsAssociatedWithUserV3 = require("./getOrganisationsAssociatedWithUserV3");
...
} = require("./getRequestsForOrganisation");
...
const routes = () => {
  ...
  router.get(
    "/v2/users",
    deprecate("/v3/users"),
    asyncWrapper(listUserOrganisationsV2),
  );
  ...
  router.get(
    ...
    asyncWrapper(getOrganisationByExternalId),
  );
  router.get(
    "/associated-with-user/:uid",
    asyncWrapper(getOrganisationsAssociatedWithUser),
  );
  router.get(
    "/v2/associated-with-user/:uid",
    asyncWrapper(getOrganisationsAssociatedWithUserV2),
  );
  router.get(
    "/v3/associated-with-user/:uid",
    asyncWrapper(getOrganisationsAssociatedWithUserV3),
  );
  router.get(
    "/users-for-approval/:uid?",
  ...
  router.post(
    "/:id/users/:uid/requests",
    asyncWrapper(createUserOrganisationRequest),
  );
  router.get("/:id/requests", asyncWrapper(getRequestsForOrganisation));
  router.get(
    "/:orgIds/requests/all",
    asyncWrapper(getRequestsForOrganisations),
  );
  router.get(
    "/:orgIds/requests/service-subService/all",
    asyncWrapper(getOrgsServicesSubServicesRequests),
  );
  router.get(
    "/:orgIds/requests/organisation-service-subService/all",
    asyncWrapper(getAllRequestsTypesAssociatedWithOrgs),
  );
  ...
  router.get(
    "/requests-for-approval/:uid",
    asyncWrapper(getPendingRequestsForApproval),
  );
  router.get(
    "/org-service-subService-requests-for-approval/:uid",
    asyncWrapper(getPendingRequestTypesForApproval),
  );
  router.get(
    "/requests-for-user/:uid",
    asyncWrapper(getPendingRequestsAssociatedWithUser),
  );
  router.get(
    "/latest-request-for-user/:uid",
    asyncWrapper(getLatestActionedRequestAssociatedWithUser),
  );

  router.get(
    "/associated-with-service/:sid",
    asyncWrapper(getOrganisationsAssociatedWithService),
  );
