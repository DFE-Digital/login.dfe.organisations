...
const { getServiceAndSubServiceReqForOrgs } = require('./../../../src/app/organisations/data/organisationsStorage');
...
describe('When getting all pending sub-service and service request for organisations', () => {
  ...
  it('then it should log errors and return 500 result if any errors', async() => {
    ...
    expect(logger.error.mock.calls[0][0]).toEqual('Error getting service and sub-service requests for organisation 1d672383-cf21-49b4-86d2-7cea955ad422,1d672383-cf21-49b4-86d2-7cea955ad421 - Sequelize error');
  });
});
